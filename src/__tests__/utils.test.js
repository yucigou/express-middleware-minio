...
describe('utils.getTempPath(filename)', () => {
  it('returns a file name with dot UUID as its suffix from the tempDir directory', () => {
...
describe('utils.removeFile(fileFullPath)', () => {
  it('removes a given file in the tempDir directory', async () => {
  ...
  it('throws error if the given file is not in the tempDir directory', () => {
  ...
  it('does not throw error if the given file is in the tempDir directory', () => {
    const filepath = `${tempDir}/my-express-middleware-minio-utils-test-file.txt`
